...
class SmallPagePainterDoubledCards extends CustomPainter {
  @override
  ...
  @override
  bool shouldRepaint(SmallPagePainterDoubledCards oldDelegate) {
    return false;
  }

  @override
  bool shouldRebuildSemantics(SmallPagePainterDoubledCards oldDelegate) {
    return false;
  }
}